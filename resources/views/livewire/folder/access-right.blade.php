                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <form wire:submit.prevent="addUserGroupAccessMode">
                                ...
                                <div class="mb-5">
                                    <label for="accessMode" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Access Mode</label>
                                    <select id="accessMode" wire:model="accessMode" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="0">All Permission</option>
                                        <option value="1">Read/Write Permission</option>
                                        <option value="2">Read Permission</option>
                                        <option value="3">No Access</option>
                                        ...
                                        @else
                                            @foreach($listAccess as $list)
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    ...
                                                    <td class="px-6 py-4">
                                                        @if($list->inherit_access == 0)
                                                            All Permission 
                                                        @elseif($list->inherit_access == 1)
                                                            Read/Write Permission 
                                                        @elseif($list->inherit_access == 2)
                                                            Read Permission 
                                                        @elseif($list->inherit_access == 3)
                                                            No Access
                                                        @endif
                                                    </td>
                                                    <td class="px-6 py-4">
